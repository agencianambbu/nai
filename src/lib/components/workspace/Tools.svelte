<script lang="ts">
	...
	const shareHandler = async (tool) => {
		...
		toast.success($i18n.t('Redirecting you to NAI Platform'));
...
<div class="my-3 mb-5">
	{#each $tools.filter((t) => query === '' || t.name
				.toLowerCase()
				.includes(query.toLowerCase()) || t.id
				.toLowerCase()
				...
				<div class="flex items-center text-left">
					<div class=" flex-1 self-center pl-1">
						...
						<div class="flex gap-1.5 px-1">
							<div class=" text-gray-500 text-xs font-medium flex-shrink-0">
								{tool.id}
							</div>
...
<div class=" my-16">
	<div class=" text-lg font-semibold mb-3 line-clamp-1">
		{$i18n.t('Made by NAI Platform')}
	</div>

	<a class=" flex space-x-4 cursor-pointer w-full mb-2 px-3 py-2" href="" target="_blank">

	...
	<div>
		...
		<div class="flex flex-col md:flex-row w-full px-5 pb-4 md:space-x-4 dark:text-gray-200">
			<div class=" flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6">
				...
				>
					<div
						class="flex text-center text-sm font-medium rounded-xl bg-transparent/10 p-1 mb-2"
					>
						<button
							class="w-full rounded-lg p-1.5 {tab === ''
						...
						<button
							class="w-full rounded-lg p-1 {tab === 'import'
								? 'bg-gray-50 dark:bg-gray-850'
								: ''}"
							type="button"
							on:click={() => {
							...
							<div>
								<div class="mb-3 w-full">
									...
									<button
										...
										on:click={() => {
											document
												.getElementById('upload-user-csv-input')
												?.click();
										}}
									>
										{#if inputFiles}
